...
namespace BusinessModel.Test
{
    ...
    public class BAM_Report_EmptyModel_Tests
    {
        ...
        public void S02_Esteem_Location_Change()
        {
            ...
            JSON_FileExport.WriteFile(_typePrefix + "S02_Esteem_Location_Change_All", newItemList, newItemList.Count, "EST_BadData");
            JSON_FileExport.WriteFile(_typePrefix + "S02_Esteem_Location_Change_Model", modelList, modelList.Count, "EST_BadData");
            JSON_FileExport.WriteFile(_typePrefix + "S02_Esteem_Location_Change_NoModel", noModelList, noModelList.Count, "EST_BadData");
            JSON_FileExport.WriteFile(_typePrefix + "S02_Esteem_Location_Change_FaultyiPad", faultyList, faultyList.Count, "EST_BadData");
        }
        ...
        public void S03_Esteem_Asset_Tag_Change()
        {
            ...
            JSON_FileExport.WriteFile(_typePrefix + "S03_Esteem_Asset_Tag_Change_All", newItemList, newItemList.Count, "EST_BadData");
            JSON_FileExport.WriteFile(_typePrefix + "S03_Esteem_Asset_Tag_Change_Model", modelList, modelList.Count, "EST_BadData");
            JSON_FileExport.WriteFile(_typePrefix + "S03_Esteem_Asset_Tag_Change_NoModel", noModelList, noModelList.Count, "EST_BadData");
            JSON_FileExport.WriteFile(_typePrefix + "S03_Esteem_Asset_Tag_Change_FaultyiPad", faultyList, faultyList.Count, "EST_BadData");
        }
        ...
        public void S04_Deployed_to_BAM_User()
        {
            ...
            JSON_FileExport.WriteFile(_typePrefix + "S04_Deployed_to_BAM_User_All", newItemList, newItemList.Count, "EST_BadData");
            JSON_FileExport.WriteFile(_typePrefix + "S04_Deployed_to_BAM_User_Model", modelList, modelList.Count, "EST_BadData");
            JSON_FileExport.WriteFile(_typePrefix + "S04_Deployed_to_BAM_User_NoModel", noModelList, noModelList.Count, "EST_BadData");
            JSON_FileExport.WriteFile(_typePrefix + "S04_Deployed_to_BAM_User_FaultyiPad", faultyList, faultyList.Count, "EST_BadData");
        }
