    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Content/plugins/dataTables/dataTablesStyles").Include(
                      ...
                      "~/Content/plugins/dataTables/Responsive-2.2.2/css/responsive.bootstrap.css",
                      "~/Content/plugins/dataTables/Responsive-2.2.2/css/responsive.datatables.css",
            ...
            bundles.Add(new ScriptBundle("~/plugins/dataTables").Include(
                      ...
                      "~/Scripts/plugins/dataTables/Responsive-2.2.2/js/responsive.bootstrap.js",
                      "~/Scripts/plugins/dataTables/Responsive-2.2.2/js/responsive.datatables.js",
                      "~/Scripts/plugins/dataTables/Responsive-2.2.2/js/datatables.tableTools.min.js"));
