...
namespace ESTReportingSite.Controllers
{
    public class PartManufacturersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CreatedDate,UpdatedDate,Name,Code,CodeEsteem,CodeEsteemAlt")] PartManufacturer partManufacturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CreatedDate,UpdatedDate,Name,Code,CodeEsteem,CodeEsteemAlt")] PartManufacturer partManufacturer)
        {
            if (ModelState.IsValid)
            {
