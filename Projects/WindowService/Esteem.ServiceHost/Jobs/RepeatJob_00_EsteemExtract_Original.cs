...
{
    public class RepeatJob_00_EsteemExtract_Original : Job
    {
        ...
        public RepeatJob_00_EsteemExtract_Original()
        {
        ...
        private void RunProcess()
        {
            ...
            {
                JSON_FileExport.WriteFile(_typePrefix + "_ScheduleRepeater_Exception_00" + DateTime.Now.ToString("yyMMddhhmm"), exp, 0, "Exception");
            }
        }
